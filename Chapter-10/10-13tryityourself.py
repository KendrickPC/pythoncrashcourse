...
# person who last used the program. Before printing a welcome back message in
# greet_user(), ask the user if this is the correct username. If it is not,
...
def greet_user():
    ...
    if username:
        correct = input("Are you " + username.title() + "? (y/n) ")
        if correct == 'y':
